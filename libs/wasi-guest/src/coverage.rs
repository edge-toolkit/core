...
//! and every guest that depends on it stays analyzed. Every other analyzer the repo runs over Rust still reads
//! the unsafe. Each guest calls this at the end of `run()`, naming the profile its own build should write.
