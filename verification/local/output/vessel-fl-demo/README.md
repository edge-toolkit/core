...
This directory contains generated deployment configs for the `vessel-fl-demo` scenario.
Files: `mise.toml`, `compose.yaml`, `k3s.yaml`.

The scenario exposes these workflow modules: pyo3-mlflow, pyo3-vessel-fl-demo, vessel-fl-client, vessel-fl-coordinator, vessel-fl-mlflow.
