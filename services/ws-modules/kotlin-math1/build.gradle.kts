...
kotlin {
    wasmJs {
        ...
        // `et_ws_kotlin_math1_compiled.mjs`, mirroring kotlin-data1's naming.
        outputModuleName.set("et_ws_kotlin_math1_compiled")
        browser()
        binaries.executable()
    }
    compilerOptions {
...
tasks.register<Sync>("pkgDist") {
    ...
    preserve {
        include("package.json", "et_ws_kotlin_math1.js", ".gitignore")
    }
}
