// et_ws_kotlin_math1.js -- ES module shim for kotlin-math1 (Kotlin/Wasm, WasmGC)
...
// while the WasmGC guest owns the kernel, reading the parsed input through the typed host
...
export default async function init() {
  ...
  // which installs globalThis.kotlinMath1Run.
  await import(new URL("et_ws_kotlin_math1_compiled.mjs", import.meta.url).href);
}

export async function run() {
  if (typeof globalThis.kotlinMath1Run !== "function") {
    throw new Error("kotlin-math1: not initialized");
  }
  await globalThis.kotlinMath1Run();
}
