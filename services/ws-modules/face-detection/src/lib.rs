...
use et_web::{
    JsCastExt as _, JsFunctionExt as _, JsPromiseExt as _, describe_js_error, get_media_devices, sleep_ms,
    websocket_url,
};
...
const FACE_MODEL_PATH: &str = concat!("/modules/", et_org::npm_scope!(), "et-model-face1/video_cv.onnx");
