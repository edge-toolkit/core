...
- `specs/wit/world.wit` — The `et:ws-wasi` world consumed by
  `services/ws-wasi-runner` and every WASI ws-module. Built with
  `wit-encoder` in `utilities/int-gen/src/wit/world.rs`.
