...
- **Rust -> WASM** (wasm-pack): audio1, bluetooth, comm1, data1, except1, face-detection, geolocation, graphics-info,
  har1, llm1, math1, math1-sender, nfc, sensor1, speech-recognition, video1 -- llm1 is the chat module, driving
  transformers.js text generation on WebGPU over the `et-model-llm1` weights, so it needs a WebGPU-capable browser
